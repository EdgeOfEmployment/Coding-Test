...
<p><img src="https://asset.programmers.co.kr/files/production/69c07bd8-1707-422c-a05d-5de3498b7048/%E1%84%80%E1%85%B3%E1%84%85%E1%85%B5%E1%86%B71.png" title="" alt="그림1.png"></p>
...
<p><img src="https://asset.programmers.co.kr/files/production/f016005d-6555-4c05-ad39-b413645b9217/%E1%84%80%E1%85%B3%E1%84%85%E1%85%B5%E1%86%B72.png" title="" alt="그림2.png"></p>

<p>그 후, 판매원 john 에 의하여 400 원의 이익이 발생합니다. john 은 10% 인 40 원을 센터에 배분하고 자신이 나머지인 360 원을 가집니다. 이 상태를 그림으로 나타내면 아래와 같습니다.</p>

<p><img src="https://asset.programmers.co.kr/files/production/89418fb8-a704-4856-81e2-f84038d71ee2/%E1%84%80%E1%85%B3%E1%84%85%E1%85%B5%E1%86%B73.png" title="" alt="그림3.png"></p>
...
<p><img src="https://asset.programmers.co.kr/files/production/ec4a60a1-bb7d-45bd-befe-1ea652d094b7/%E1%84%80%E1%85%B3%E1%84%85%E1%85%B5%E1%86%B74.png" title="" alt="그림4.png"></p>
...
<p><img src="https://asset.programmers.co.kr/files/production/4fb2164f-71b0-48ff-a2d0-e2fd8133e329/%E1%84%80%E1%85%B3%E1%84%85%E1%85%B5%E1%86%B75.png" title="" alt="그림5.png"></p>

<p>마지막으로, 판매원 mary 는 1,000 원의 이익을 달성하고, 이 중 10% 인 100 원을 센터에 배분한 후 그 나머지인 900 원을 자신이 가집니다. 이 상태를 그림으로 나타내면 아래와 같습니다.</p>

<p><img src="https://asset.programmers.co.kr/files/production/0527a713-4fc4-47db-98d3-49ce6d911dfd/%E1%84%80%E1%85%B3%E1%84%85%E1%85%B5%E1%86%B76.png" title="" alt="그림6.png"></p>

<p>위와 같이 하여 모든 조직 구성원들의 이익 달성 현황 집계가 끝났습니다. 지금까지 얻은 이익을 모두 합한 결과를 그림으로 나타내면 아래와 같습니다.</p>

<p><img src="https://asset.programmers.co.kr/files/production/970f1df0-4f00-480f-93a3-13c7e30b19cb/%E1%84%80%E1%85%B3%E1%84%85%E1%85%B5%E1%86%B77.png" title="" alt="그림7.png"></p>
...
- 트리(추천인 체인) 구조 + 시뮬레이션
- enroll/referral을 이용해 각 판매원의 "추천인"을 `Map<이름, { parent, index }>` 형태로 저장 → 이름으로 부모와 결과 배열의 인덱스를 O(1)에 조회
- 각 판매 기록마다 seller부터 시작해 추천인 체인을 따라 올라가며 이익금을 분배
  - 현재 사람이 갖는 몫: `profit - Math.floor(profit / 10)`
  - 다음 사람에게 넘기는 몫: `Math.floor(profit / 10)`
  - profit이 0이 되거나 추천인이 `'-'`(=센터)에 도달하면 종료

### 시간 복잡도에 대한 생각 (핵심 포인트)

- 얼핏 보면 while 루프가 조직의 깊이(최대 10,000)만큼 돌 수 있어 보여서, seller.length(최대 100,000) × enroll.length(최대 10,000)로 최악의 경우 시간 초과가 걱정될 수 있음
- 하지만 매 단계마다 금액이 10%로 줄어들고(그것도 원 단위 절사) amount의 최댓값이 100이므로, profit은 최대 10,000원에서 시작해 10,000 → 1,000 → 100 → 10 → 1 → 0으로 급격히 줄어듦
- 즉 체인이 아무리 길어도 while 루프는 실제로 최대 log10(10000) ≈ 5번 안팎만 반복되고, `profit > 0` 조건이 사실상 루프를 자동으로 짧게 끊어주는 장치 역할을 함
- 따라서 실제 시간 복잡도는 O(seller.length × log(amount_max × 100))에 가까워 매우 빠르게 동작

### 느낀 점

- 문제 제약(최대 판매 수량 100, 개당 이익 100원)을 보고 "이익금이 절사를 거듭하며 빠르게 0에 수렴한다"는 사실을 캐치하는 것이 이 문제의 핵심 포인트였음
- 별도의 트리 자료구조 없이 Map 하나로 부모 포인터만 저장해도 충분하다는 점에서, 필요 이상으로 무거운 자료구조를 만들지 않는 연습이 됨
